...
StaticShock.prototype.setController = function(controller, merge) {
    switch(typeof controller) {
        case 'function':
            try {
                controller = controller(this, new Handler(this._options), this._options, this._controller);
            }
            catch(ex) {
...
StaticShock.prototype.buildFile = function(file) {
    ...
    if(this._fileCache[file] == null) {
        this._fileCache[file] = fs.readFileSync(file);
    }

    var data = {
        content: this._fileCache[file],
    ...
    if(this._controller && this._controller.PreBuildFile) {
        this._controller.PreBuildFile(data, this, this._options);
    }
    ...
    if(this._controller && this._controller.PostBuildFile) {
        this._controller.PostBuildFile(data, this, this._options);
    }
...
StaticShock.prototype.build = function() {
    ...
    if(this._options.clean) {
        try {
            if(this._controller && this._controller.PreClean) {
                this._controller.PreClean(this, this._options);
            }
            if(functions.rmdir(this._options.out)) {
                ...
                if(this._controller && this._controller.PostClean) {
                    this._controller.PostClean(this, this._options);
                }
            }
        }
        catch(ex) {
    ...
    if(this._controller && this._controller.PreBuild) {
        this._controller.PreBuild(this, this._options);
    }
    ...
    if(this._controller && this._controller.PostBuild) {
        this._controller.PostBuild(this, this._options);
    }
